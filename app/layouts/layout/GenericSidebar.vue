  ...
  <aside class="generic-sidebar" :class="{ 'generic-sidebar--open': isOpen, 'generic-sidebar--admin': isAdminPage }">
    <nav class="generic-sidebar__nav">
      ...
      <template v-if="isAdminPage">
        <NuxtLink to="/admin/dashboard" class="generic-sidebar__nav-item"
        ...
        <NuxtLink to="/admin/organizers" class="generic-sidebar__nav-item"
          active-class="generic-sidebar__nav-item--active" @click="handleLinkClick">
          <span class="generic-sidebar__nav-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <NuxtLink :to="venuesRoute" class="generic-sidebar__nav-item"
          active-class="generic-sidebar__nav-item--active" @click="handleLinkClick">
          <span class="generic-sidebar__nav-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <NuxtLink :to="eventsRoute" class="generic-sidebar__nav-item"
          active-class="generic-sidebar__nav-item--active" @click="handleLinkClick">
          <span class="generic-sidebar__nav-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <NuxtLink to="/admin/settings" class="generic-sidebar__nav-item"
          active-class="generic-sidebar__nav-item--active" @click="handleLinkClick">
          <span class="generic-sidebar__nav-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
      ...
      <!-- Visitor Navigation -->
      <template v-else>
        <NuxtLink v-if="tokenStore.isAuthenticated" to="/admin/dashboard" class="generic-sidebar__nav-item"
          active-class="generic-sidebar__nav-item--active" @click="handleLinkClick">
          <span class="generic-sidebar__nav-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z" fill="currentColor" />
        ...
        <NuxtLink to="/" class="generic-sidebar__nav-item" :class="{ 'generic-sidebar__nav-item--active': route.path === '/' }" exact @click="handleLinkClick">
          <span class="generic-sidebar__nav-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <NuxtLink to="/contribute" class="generic-sidebar__nav-item" active-class="generic-sidebar__nav-item--active" @click="handleLinkClick">
          <span class="generic-sidebar__nav-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z" fill="currentColor" />
            </svg>
          </span>
          <span class="generic-sidebar__nav-text">{{ t('visitor_nav_contribute') }}</span>
        </NuxtLink>

        <NuxtLink to="/about" class="generic-sidebar__nav-item" active-class="generic-sidebar__nav-item--active" @click="handleLinkClick">
          <span class="generic-sidebar__nav-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <NuxtLink v-if="!tokenStore.isAuthenticated" to="/app/login" class="generic-sidebar__nav-item"
          active-class="generic-sidebar__nav-item--active" @click="handleLinkClick">
          <span class="generic-sidebar__nav-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
    ...
    <div class="generic-sidebar__footer-mobile">
      <GenericFooter />
    </div>
  </aside>
</template>
...
.generic-sidebar__footer-mobile {
  display: none;
  width: 100%;
