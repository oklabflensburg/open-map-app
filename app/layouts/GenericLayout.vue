    ...
    <div class="generic-layout">
        ...
        <div class="generic-layout__container">
            ...
            <main class="generic-layout__main">
                ...
                <GenericFooter class="generic-layout__footer-desktop" />
            </main>
        </div>
    </div>
</template>
...
import GenericHeader from './layout/GenericHeader.vue'
import GenericSidebar from './layout/GenericSidebar.vue'
import GenericFooter from './layout/GenericFooter.vue'
...
@media (max-width: 768px) {
  .generic-layout__footer-desktop {
    display: none;
  }
}
